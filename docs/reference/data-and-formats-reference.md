...
**Local Schema Files:**
When a schema name is specified (e.g., `avro:SensorReading`), KSML loads the schema from a local file in the
`schemaDirectory`. The notation determines the filename extension:
