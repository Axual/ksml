...
* [Release Notes](#release-notes)
    * [Releases](#releases)
        * [1.1.1 (2025-10-20)](#111-2025-10-20)
...
* Fix Helm charts to skip ServiceMonitor and PrometheusRule creation for Job deployments ([#316](https://github.com/Axual/ksml/pull/316))
