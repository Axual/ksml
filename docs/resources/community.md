...
- [Tutorials](../tutorials/beginner/index.md) - For hands-on learning
...
Check the [community calendar](https://axual.com/community/calendar) for upcoming calls.
...
Look for KSML presentations at these conferences:
