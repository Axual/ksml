...
public class ResolvingPartitionInfo extends PartitionInfo {
    ...
    @Override
    public Node leader() {
        throw unsupported("leader");
    }

    @Override
    public Node[] replicas() {
        throw unsupported("replicas");
    }

    @Override
    public Node[] inSyncReplicas() {
        throw unsupported("inSyncReplicas");
    }
    ...
    private UnsupportedOperationException unsupported(String operation) {
        return new UnsupportedOperationException(getClass().getSimpleName() + "." + operation);
    }
}
