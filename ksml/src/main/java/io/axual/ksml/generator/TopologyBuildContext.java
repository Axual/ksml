...
public class TopologyBuildContext {
    ...
    private StreamWrapper validateStreamWrapper(StreamWrapper wrapper, TopicDefinition definition, Class<? extends BaseStreamWrapper> resultType) {
        if (definition != null) {
            ...
            if (defKeyType != null && !defKeyType.dataType().checkAssignableFrom(wrapperKeyType.dataType()).isOK()) {
            ...
            if (defValueType != null && !defValueType.dataType().checkAssignableFrom(wrapperValueType.dataType()).isOK()) {
