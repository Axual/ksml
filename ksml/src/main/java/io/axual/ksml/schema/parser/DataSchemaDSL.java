...
public class DataSchemaDSL {
    ...
    public static final String STRUCT_SCHEMA_FIELD_CONSTANT_FIELD = "constant";
    public static final String STRUCT_SCHEMA_FIELD_DEFAULT_VALUE_FIELD = "defaultValue";
    public static final String STRUCT_SCHEMA_FIELD_DOC_FIELD = "doc";
    public static final String STRUCT_SCHEMA_FIELD_NAME_FIELD = "name";
    public static final String STRUCT_SCHEMA_FIELD_ORDER_FIELD = "order";
    public static final String STRUCT_SCHEMA_FIELD_REQUIRED_FIELD = "required";
    public static final String STRUCT_SCHEMA_FIELD_SCHEMA_FIELD = DATA_SCHEMA_TYPE_FIELD;
    public static final String STRUCT_SCHEMA_FIELD_TAG_FIELD = "tag";
