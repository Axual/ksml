...
public class KeyValueStateStoreDefinitionParser extends DefinitionParser<KeyValueStateStoreDefinition> implements NamedObjectParser {
    ...
    protected StructsParser<KeyValueStateStoreDefinition> parser() {
        ...
        final var keyTypeField = optional(userTypeField(KSMLDSL.Stores.KEY_TYPE, "The key type of the keyValue store", true));
        final var valueTypeField = optional(userTypeField(KSMLDSL.Stores.VALUE_TYPE, "The value type of the keyValue store", true));
