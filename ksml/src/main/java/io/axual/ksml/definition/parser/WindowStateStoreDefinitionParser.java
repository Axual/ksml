...
public class WindowStateStoreDefinitionParser extends DefinitionParser<WindowStateStoreDefinition> implements NamedObjectParser {
    ...
    protected StructsParser<WindowStateStoreDefinition> parser() {
        ...
        final var keyTypeField = userTypeField(KSMLDSL.Stores.KEY_TYPE, "The key type of the window store", true);
        final var valueTypeField = userTypeField(KSMLDSL.Stores.VALUE_TYPE, "The value type of the window store", true);
