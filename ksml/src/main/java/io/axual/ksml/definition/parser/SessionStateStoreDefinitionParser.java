...
public class SessionStateStoreDefinitionParser extends DefinitionParser<SessionStateStoreDefinition> implements NamedObjectParser {
    ...
    protected StructsParser<SessionStateStoreDefinition> parser() {
        ...
        final var keyTypeField = userTypeField(KSMLDSL.Stores.KEY_TYPE, "The key type of the session store", true);
        final var valueTypeField = userTypeField(KSMLDSL.Stores.VALUE_TYPE, "The value type of the session store", true);
