...
public class KeyValueToKeyValueListTransformerDefinitionParser extends FunctionDefinitionParser {
    ...
    public StructParser<FunctionDefinition> parser() {
        return parserWithStores(KSMLDSL.Functions.TYPE_KEYVALUETOKEYVALUELISTTRANSFORMER, "keyvalue-to-keyvaluelist transformer", KeyValueToKeyValueListTransformerDefinition::new);
    }
}
