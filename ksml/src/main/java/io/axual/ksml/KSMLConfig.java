...
public record KSMLConfig(String sourceType, String configDirectory, String schemaDirectory,
    ...
    @Builder
    public KSMLConfig(String sourceType, String configDirectory, String schemaDirectory, Object source, NotationLibrary notationLibrary, ErrorHandler consumeErrorHandler, ErrorHandler produceErrorHandler, ErrorHandler processErrorHandler) {
