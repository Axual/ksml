...
public class ToTopicNameExtractorOperation extends BaseOperation {
    ...
    public StreamWrapper apply(KStreamWrapper input, TopologyBuildContext context) {
        ...
        final var part = userFunctionOf(context, PARTITIONER_NAME, partitioner, DataInteger.DATATYPE, equalTo(DataString.DATATYPE), superOf(k), superOf(v), equalTo(DataInteger.DATATYPE));
