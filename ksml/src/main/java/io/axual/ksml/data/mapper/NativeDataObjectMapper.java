...
public class NativeDataObjectMapper implements DataObjectMapper<Object> {
    ...
    private DataType inferType(Object value) {
        if (value == null) return DataNone.DATATYPE;
    ...
    public DataObject toDataObject(DataType expected, Object value) {
        if (value == null) return new DataNone();
    ...
    public DataRecord mapToDataRecord(Map<?, ?> map, RecordSchema schema) {
    ...
    public Object fromDataObject(DataObject value) {
        if (value instanceof DataNone val) return val.value();
