...
public class RecordContextSchema {
    ...
    private static StructSchema generateRecordContextSchema() {
        ...
        fields.add(new StructField(RECORD_CONTEXT_SCHEMA_OFFSET_FIELD, DataSchema.LONG_SCHEMA, RECORD_CONTEXT_SCHEMA_OFFSET_DOC));
        fields.add(new StructField(RECORD_CONTEXT_SCHEMA_TIMESTAMP_FIELD, DataSchema.LONG_SCHEMA, RECORD_CONTEXT_SCHEMA_TIMESTAMP_DOC));
        fields.add(new StructField(RECORD_CONTEXT_SCHEMA_TOPIC_FIELD, DataSchema.STRING_SCHEMA, RECORD_CONTEXT_SCHEMA_TOPIC_DOC));
        fields.add(new StructField(RECORD_CONTEXT_SCHEMA_PARTITION_FIELD, DataSchema.INTEGER_SCHEMA, RECORD_CONTEXT_SCHEMA_PARTITION_DOC));
        fields.add(new StructField(RECORD_CONTEXT_SCHEMA_HEADERS_FIELD, new ListSchema(HEADER_SCHEMA), RECORD_CONTEXT_SCHEMA_HEADERS_DOC));
