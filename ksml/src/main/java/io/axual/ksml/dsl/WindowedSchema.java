...
public class WindowedSchema {
    ...
    public static StructSchema generateWindowedSchema(WindowedType windowedType, Function<DataType, DataSchema> dataTypeToSchema) {
        ...
        fields.add(new StructField(WINDOWED_SCHEMA_START_FIELD, DataSchema.LONG_SCHEMA, WINDOWED_SCHEMA_START_FIELD_DOC));
        fields.add(new StructField(WINDOWED_SCHEMA_END_FIELD, DataSchema.LONG_SCHEMA, WINDOWED_SCHEMA_END_FIELD_DOC));
        fields.add(new StructField(WINDOWED_SCHEMA_START_TIME_FIELD, DataSchema.STRING_SCHEMA, WINDOWED_SCHEMA_START_TIME_FIELD_DOC));
        fields.add(new StructField(WINDOWED_SCHEMA_END_TIME_FIELD, DataSchema.STRING_SCHEMA, WINDOWED_SCHEMA_END_TIME_FIELD_DOC));

        var keySchema = dataTypeToSchema.apply(windowedType.keyType());
        fields.add(new StructField(WINDOWED_SCHEMA_KEY_FIELD, keySchema, WINDOWED_SCHEMA_KEY_FIELD_DOC));
