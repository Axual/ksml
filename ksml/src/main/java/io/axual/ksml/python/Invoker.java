...
public class Invoker {
    ...
    protected void verifyResultReturned(DataType expected) {
        ...
        verify(expected.isAssignableFrom(function.resultType), "Function returns incompatible type: " + function.resultType + ", expected " + expected);
    }

    protected void verifyResultType(DataType type) {
        verify(type.isAssignableFrom(function.resultType), "Function returns " + function.resultType + " instead of " + type);
    }
}
