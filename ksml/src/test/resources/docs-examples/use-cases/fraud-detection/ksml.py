...
if TYPE_CHECKING:
    ...
    class TimestampedKeyValueStore(StateStore, Protocol):
        ...
        def putIfAbsent(self, key: Any, value: Dict[str, Any]) -> Optional[Dict[str, Any]]: ...
        def putIfAbsent(self, key: Any, value: Any, timestamp: int) -> Optional[Dict[str, Any]]: ...
        def delete(self, key: Any) -> Optional[Dict[str, Any]]: ...
        def range(self, from_key: Any, to_key: Any) -> Iterator[Any]: ...
        def all(self) -> Iterator[Any]: ...
        def approximateNumEntries(self) -> int: ...
    ...
    class TimestampedWindowStore(StateStore, Protocol):
        ...
        def put(self, key: Any, value: Dict[str, Any], windowStartTimestamp: int) -> None: ...
