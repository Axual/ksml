...
import io.axual.ksml.schema.DataSchemaMapper;
...
import static io.axual.ksml.schema.DataSchemaConstants.DATAFIELD_SCHEMA_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.DATASCHEMA_TYPE_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.ENUMSCHEMA_DEFAULTVALUE_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.ENUMSCHEMA_POSSIBLEVALUES_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.FIXEDSCHEMA_SIZE_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.LISTSCHEMA_VALUES_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.MAPSCHEMA_VALUES_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.NAMEDSCHEMA_DOC_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.NAMEDSCHEMA_NAMESPACE_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.NAMEDSCHEMA_NAME_FIELD;
import static io.axual.ksml.schema.DataSchemaConstants.STRUCTSCHEMA_FIELDS_FIELD;
...
public class NativeDataSchemaMapper implements DataSchemaMapper<Object> {
    ...
    private Object encodeDefaultValue(Map<String, Object> node, String fieldName, DataValue defaultValue) {
        ...
        throw new KSMLDataException("Can not encode default value of type: " + defaultValue.getClass().getSimpleName());
    }
}
