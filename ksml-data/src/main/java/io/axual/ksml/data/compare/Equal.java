...
public class Equal {
    ...
    private Equal(String errorMessage, Equal cause) {
    ...
    public static Equal error(String errorMessage) {
        return error(errorMessage, null);
    }

    public static Equal error(String errorMessage, Equal cause) {
        return errorMessage != null ? new Equal(errorMessage, cause) : ok();
    }
