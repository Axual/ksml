...
public class PythonDataObjectMapper extends BaseDataObjectMapper {
    ...
    public DataObject toDataObject(DataType expected, Object object) {
        ...
        throw new KSMLDataException("Can not convert Python object to DataObject: " + (object != null ? object.getClass().getSimpleName() : "null"));
    }
    ...
    private DataObject unionToDataObject(UnionType unionType, Object object) {
        ...
        throw new KSMLDataException("Can not convert Python dataType to Union value: " + object.getClass().getSimpleName());
    }
    ...
    private Object unwrapValue(DataType expected, Value object) {
        ...
        throw new KSMLDataException("Can not convert Python dataType to DataObject: " + object.getClass().getSimpleName());
    }
    ...
    public Value fromDataObject(DataObject object) {
        ...
        throw new KSMLDataException("Can not convert DataObject to Python dataType: " + object.getClass().getSimpleName());
    }
}
