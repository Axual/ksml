...
public class JsonNodeNativeMapper {
    ...
    public JsonNode fromNative(Object value) {
        ...
        throw new ExecutionException("Can not convert to JsonNode: " + (value != null ? value.getClass().getSimpleName() : "null"));
    }
    ...
    private JsonNode addToArrayNode(ArrayNode node, Object value) {
        ...
        throw new ExecutionException("Can not add value to ObjectNode: " + value.getClass().getSimpleName());
    }
    ...
    public Object toNative(JsonNode node) {
        ...
        throw new ExecutionException("Can not convert from JsonNode: " + node.toPrettyString());
    }
    ...
    private Object toNativeValue(JsonNode value) {
        try {
            ...
            throw new ExecutionException("Can not convert from JSON value: " + value.getClass().getSimpleName(), e);
        }
        throw new ExecutionException("Can not convert from JSON value: " + value.getClass().getSimpleName());
    }
}
