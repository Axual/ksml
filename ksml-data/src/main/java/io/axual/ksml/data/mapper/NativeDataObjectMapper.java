...
public class NativeDataObjectMapper extends BaseDataObjectMapper {
    ...
    public DataObject toDataObject(DataType expected, Object value) {
        ...
        throw new KSMLDataException("Can not convert to DataObject: " + value.getClass().getSimpleName());
    }
    ...
    public Object fromDataObject(DataObject value) {
        ...
        throw new KSMLDataException("Can not convert DataObject to native dataType: " + value.getClass().getSimpleName());
    }
}
