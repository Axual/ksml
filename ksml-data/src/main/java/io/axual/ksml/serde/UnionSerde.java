...
public class UnionSerde implements Serde<Object> {
    ...
    private class UnionSerializer implements Serializer<Object> {
        ...
        public byte[] serialize(String topic, Object data) {
            ...
            throw new KSMLDataException("Can not serialize object as union alternative: " + (data != null ? data.getClass().getSimpleName() : "null"));
        }
    }
    ...
    private class UnionDeserializer implements Deserializer<Object> {
        ...
        public Object deserialize(String topic, byte[] data) {
            ...
            throw new KSMLDataException("Can not deserialize data as union possible dataType" + (data != null ? data : "null"));
        }
    }
