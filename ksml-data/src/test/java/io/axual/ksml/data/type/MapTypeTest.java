...
class MapTypeTest {
    ...
    void assignabilityBetweenMaps() {
        ...
        assertThat(numberMap.isAssignableFrom(integerMap).isAssignable()).isTrue();
        assertThat(integerMap.isAssignableFrom(numberMap).isAssignable()).isFalse();

        // Different container class (e.g., ListType) is not assignable
        var listOfNumber = new ListType(new SimpleType(Number.class, "number"));
        assertThat(numberMap.isAssignableFrom(listOfNumber).isAssignable()).isFalse();
    }
    ...
    void assignabilityFromClass() {
        ...
        assertThat(anyMap.isAssignableFrom(HashMap.class).isAssignable()).isTrue();
        assertThat(anyMap.isAssignableFrom(String.class).isAssignable()).isFalse();
    }
