...
class NamedSchemaTest {
    ...
    void basicBehaviors() {
        TestNamedSchema unnamed = new TestNamedSchema(DataSchemaConstants.STRUCT_TYPE, "ns", null, null);
        ...
        TestNamedSchema named = new TestNamedSchema(DataSchemaConstants.STRUCT_TYPE, "ns", "Person", "doc");
    ...
    void isAssignableFromRules() {
        TestNamedSchema base = new TestNamedSchema(DataSchemaConstants.STRUCT_TYPE, "ns1", "A", "doc1");
        // StructSchema is a NamedSchema with same type "struct"
        StructSchema struct = new StructSchema("ns2", "B", "doc2", null);
        assertThat(base.isAssignableFrom(struct)).isTrue();

        // Different type not assignable
        TestNamedSchema enumNamed = new TestNamedSchema(DataSchemaConstants.ENUM_TYPE, "ns", "E", null);
