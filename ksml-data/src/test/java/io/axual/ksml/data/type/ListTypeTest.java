...
class ListTypeTest {
    ...
    void assignabilityBetweenLists() {
        ...
        assertThat(numberList.checkAssignableFrom(integerList).isOK()).isTrue();
        assertThat(integerList.checkAssignableFrom(numberList).isOK()).isFalse();

        // Different container class (e.g., MapType) is not assignable
        var mapOfNumber = new MapType(new SimpleType(Number.class, "number"));
        assertThat(numberList.checkAssignableFrom(mapOfNumber).isOK()).isFalse();
    }
    ...
    void assignabilityFromClass() {
        ...
        assertThat(anyList.checkAssignableFrom(ArrayList.class).isOK()).isTrue();
        assertThat(anyList.checkAssignableFrom(String.class).isOK()).isFalse();
    }
