...
public class NativeDataObjectMapper implements DataObjectMapper<Object> {
    ...
    public NativeDataObjectMapper(DataSchemaMapper<DataType> schemaMapper, DataSchemaMapper<Object> schemaSerde) {
        this.schemaMapper = schemaMapper;
        this.schemaSerde = schemaSerde;
    }
...
//            return userType.
    ...
    protected DataObject nativeToDataStruct(Map<String, Object> map, DataSchema schema) {
        ...
        map.forEach((key, value) -> {
            ...
            var subType = schemaMapper.fromDataSchema(fieldSchema);
