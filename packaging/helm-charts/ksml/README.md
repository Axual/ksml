...
| deploymentMode                                     | string | `"StatefulSet"` | Define the k8s-resource selected to deploy the KSML Runner. When set to `Job`, the `PrometheusRule` "Down" alert is disabled (incompatible with Job lifecycle).                                                                                           |
...
| prometheusRule.enabled                             | bool | `false` | Enables creation of Prometheus Operator [PrometheusRule](https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.PrometheusRule). Ignored if prometheus is disabled.                                                             |
...
| replicaCount                                       | int | `1` |                                                                                                                                                                                                                                                           |
| resources                                          | object | `{}` |                                                                                                                                                                                                                                                           |
| runtimeClassName                                   | string | `""` | RuntimeClassName refers to a RuntimeClass object in the node.k8s.io group, which should be used to run this pod. If no RuntimeClass resource matches the named class, the pod will not be run. If unset or empty, the "legacy" RuntimeClass will be used. |
...
| serviceMonitor.enabled                             | bool | `false` | Enables creation of Prometheus Operator [ServiceMonitor](https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitor). Ignored if prometheus is disabled.                                                             |
