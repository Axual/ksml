...
class ApicurioProtobufFileElementDescriptorMapperTest {
    ...
    @Test
    @DisplayName("Message with oneOf block produces FileDescriptor with oneOf descriptor and correct branches")
