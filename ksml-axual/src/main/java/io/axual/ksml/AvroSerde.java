...
public class AvroSerde extends AxualSerde<GenericRecord> {
    ...
    public AvroSerde(Map<String, Object> configs, AvroType type, boolean isKey) {
        super(getConfig(configs, type), isKey);
        this.type = type;
    }

    private static Map<String, Object> getConfig(Map<String, Object> configs, AvroType type) {
